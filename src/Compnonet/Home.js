    ...
    return (
        <div className='container mt-5 home-container'>
            <div className='row'>
                ...
                <img src={img1} alt='homeimg' className='img-fluid' />
                </div>
                 <div className='col-md-6'>
                     <h1 className='text-muted fe-bold'>Welcome To AJ Blogs</h1> 
                     <p className='mt-3 '>
                     ...
                     <Link className='btn bg-success text-white mt-5' to="/blog">Read Blogs</Link>           
                </div>
